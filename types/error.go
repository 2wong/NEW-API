...
const (
	...
	ErrorCodeUpstreamKeywordCaptured ErrorCode = "upstream_keyword_captured"
...
func IsUpstreamKeywordCapturedError(err *NewAPIError) bool {
	if err == nil {
		return false
	}
	return err.errorCode == ErrorCodeUpstreamKeywordCaptured
}
